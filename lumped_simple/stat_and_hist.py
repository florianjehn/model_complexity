...
def make_hist(filename, threshold):
    ...
    plt.xlim([0, 1])
    plt.savefig("histogram_simple_lumped_rope_70000_ndir_10000_all_runs.png")
    plt.close()
    ...
    plt.xlim([0, 1])
    plt.savefig("histogram_simple_lumped_rope_70000_ndir_10000_best_1000.png")
    plt.close()


make_hist("simple_lumped_rope_70000_ndir_10000.csv", 0.65)
